...
class multi_task(nn.Module):
    ...
    def __init__(self, bit_size = 2048, embedding_size = 200, max_length = 200, window_height = 5, num_filter = 4096, dropout_rate=0):
        ...
        self.pool_conv1     = nn.MaxPool2d(kernel_size = (max_length - window_height + 1, 1)) # Output of layer maxpooling is outout of share layer 
        #====================
        # Task 1
    ...
    def forward(self, x):
        ...
        # Max-pooling
        out_share_layer           = self.pool_conv1(out_conv).view(-1, 1, self.pooled_size) # torch.Size([batch, 1, 2048])
        #====================    
        # Task layers
        #====================
        # Task 1
